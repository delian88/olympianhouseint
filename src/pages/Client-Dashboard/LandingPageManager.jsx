        ...
        <SectionCard id="home-supporters" title="OurPartners / Supporters" description="Edit the support strip on the homepage." onSave={() => requestSave(async () => { setConfig((current) => ({ ...current, homePage: draftConfig.homePage })); toast.success("Supporters saved!"); }, "OurPartners / Supporters")} saveLabel="Update Section">
          <div className="space-y-4">
            <div className="flex items-center gap-2 rounded-xl border border-border bg-muted/40 p-4">
              <input
                type="checkbox"
                id="supporters-enabled"
                checked={draftConfig.homePage?.supporters?.isEnabled !== false}
                onChange={(e) => updateHomePage("supporters", "isEnabled", e.target.checked)}
                className="h-4 w-4 rounded border-gray-300 text-primaryColor focus:ring-primaryColor"
              />
              <label htmlFor="supporters-enabled" className="text-sm font-semibold text-foreground">
        ...
        <SectionCard id="background-page" title="Background Page" description="Edit the Background page content." onSave={() => requestSave(async () => { setConfig((current) => ({ ...current, backgroundPage: draftConfig.backgroundPage })); toast.success("Background page saved!"); addNotification("Background page content has been updated.", "success", "Background Page Saved"); }, "Background Page")} saveLabel="Update Background Page">
          <div className="space-y-8">
            <div className="space-y-4 rounded-2xl border border-border bg-muted/40 p-4">
              ...
              <Field label="Description"><TextArea rows={3} value={draftConfig.backgroundPage?.hero?.description || ""} onChange={(e) => updateBackgroundPageSection("hero", "description", e.target.value)} /></Field>
              <div className="grid gap-3 sm:grid-cols-2">
                <Field label="Primary CTA label"><TextInput value={draftConfig.backgroundPage?.hero?.primaryCtaLabel || ""} onChange={(e) => updateBackgroundPageSection("hero", "primaryCtaLabel", e.target.value)} /></Field>
                <Field label="Primary CTA link"><TextInput value={draftConfig.backgroundPage?.hero?.primaryCtaHref || ""} onChange={(e) => updateBackgroundPageSection("hero", "primaryCtaHref", e.target.value)} /></Field>
                <Field label="Secondary CTA label"><TextInput value={draftConfig.backgroundPage?.hero?.secondaryCtaLabel || ""} onChange={(e) => updateBackgroundPageSection("hero", "secondaryCtaLabel", e.target.value)} /></Field>
                <Field label="Secondary CTA link"><TextInput value={draftConfig.backgroundPage?.hero?.secondaryCtaHref || ""} onChange={(e) => updateBackgroundPageSection("hero", "secondaryCtaHref", e.target.value)} /></Field>
              </div>
            </div>
            ...
            <div className="space-y-4 rounded-2xl border border-border bg-muted/40 p-4">
              ...
              <Field label="Paragraph 2"><TextArea rows={4} value={draftConfig.backgroundPage?.founder?.paragraph2 || ""} onChange={(e) => updateBackgroundPageSection("founder", "paragraph2", e.target.value)} /></Field>
              <Field label="Paragraph 3"><TextArea rows={4} value={draftConfig.backgroundPage?.founder?.paragraph3 || ""} onChange={(e) => updateBackgroundPageSection("founder", "paragraph3", e.target.value)} /></Field>
              <Field label="Quote"><TextArea rows={2} value={draftConfig.backgroundPage?.founder?.quote || ""} onChange={(e) => updateBackgroundPageSection("founder", "quote", e.target.value)} /></Field>
              <Field label="Quote Author"><TextInput value={draftConfig.backgroundPage?.founder?.quoteAuthor || ""} onChange={(e) => updateBackgroundPageSection("founder", "quoteAuthor", e.target.value)} /></Field>
              <Field label="Quote Role"><TextInput value={draftConfig.backgroundPage?.founder?.quoteRole || ""} onChange={(e) => updateBackgroundPageSection("founder", "quoteRole", e.target.value)} /></Field>
              <div className="grid gap-3 sm:grid-cols-2">
                <Field label="CTA label"><TextInput value={draftConfig.backgroundPage?.founder?.ctaLabel || ""} onChange={(e) => updateBackgroundPageSection("founder", "ctaLabel", e.target.value)} /></Field>
                <Field label="CTA link"><TextInput value={draftConfig.backgroundPage?.founder?.ctaHref || ""} onChange={(e) => updateBackgroundPageSection("founder", "ctaHref", e.target.value)} /></Field>
              </div>
            </div>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <div className="space-y-4 rounded-2xl border border-border bg-muted/40 p-4">
                ...
                <Field label="Eyebrow"><TextInput value={draftConfig.backgroundPage?.foundation?.eyebrow || ""} onChange={(e) => updateBackgroundPageSection("foundation", "eyebrow", e.target.value)} /></Field>
                <Field label="Title"><TextInput value={draftConfig.backgroundPage?.foundation?.title || ""} onChange={(e) => updateBackgroundPageSection("foundation", "title", e.target.value)} /></Field>
                <Field label="Description"><TextArea rows={5} value={draftConfig.backgroundPage?.foundation?.description || ""} onChange={(e) => updateBackgroundPageSection("foundation", "description", e.target.value)} /></Field>
              </div>
              <div className="space-y-4 rounded-2xl border border-border bg-muted/40 p-4">
                <h3 className="text-lg font-bold text-foreground">What drives us</h3>
                <Field label="Eyebrow"><TextInput value={draftConfig.backgroundPage?.vision?.eyebrow || ""} onChange={(e) => updateBackgroundPageSection("vision", "eyebrow", e.target.value)} /></Field>
                <Field label="Title"><TextInput value={draftConfig.backgroundPage?.vision?.title || ""} onChange={(e) => updateBackgroundPageSection("vision", "title", e.target.value)} /></Field>
                <Field label="Description"><TextArea rows={5} value={draftConfig.backgroundPage?.vision?.description || ""} onChange={(e) => updateBackgroundPageSection("vision", "description", e.target.value)} /></Field>
              </div>
            </div>
          </div>
        </SectionCard>
